      ...
      features: [
        {
          ...
          geometry: {
            type: "Point",
            coordinates: [85.6084732, 21.6465777], // Longitude and latitude of Keonjhar Town
          },
        },

        {
          ...
          geometry: {
            type: "Point",
            coordinates: [85.752382, 21.3766333], // Longitude and latitude of Ghatagaon
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.3861248, 22.1110161], // Longitude and latitude of Barbil
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.4336801, 22.0179369], // Longitude and latitude of Joda
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [86.1199915, 21.2141961], // Longitude and latitude of Anandapur
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.3736123, 21.3954634], // Longitude and latitude of Banspal
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [86.3072658, 21.2168089], // Longitude and latitude of Hatadihi
          },
        },
        // Additional places
        {
          ...
          geometry: {
            type: "Point",
            coordinates: [85.6643914, 22.0653768], // Longitude and latitude of Champua
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.5713402, 21.8272708], // Longitude and latitude of Jhumpura
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.5318924, 21.7551929], // Longitude and latitude of Patna
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.9462478, 21.7385891], // Longitude and latitude of Saharpada
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [86.1140584, 21.211304], // Longitude and latitude of Ghasipura
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.3941321, 21.3586543], // Longitude and latitude of Telkoi
          },
        },
        {
          type: "Feature",
          ...
          geometry: {
            type: "Point",
            coordinates: [85.7913888, 21.3401686], // Longitude and latitude of Harichandanpur
          },
        },
      ],
    });
    setSelectedArea([85.9169226, 21.502322]);
    setZoomArea(8);
  };
    ...
    <div>
      ...
      <div className="dashboard-page">
        ...
        >
          ...
          <button
            className="sidebarStyle dist-bat-style"
            variant="contained"
